...
const Portfolio = () => {
  ...
  <input
    ...
    max="120"
    value={
      droppedElements.find((element) => element.id === selectedElementId)?.fontSize || 12
    }
    onChange={(e) =>
      handleFontSizeChange(selectedElementId, Number(e.target.value)) // Ensure conversion to Number
    }
  />
</label>
